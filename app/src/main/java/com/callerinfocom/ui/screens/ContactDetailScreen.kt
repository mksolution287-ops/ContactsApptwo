...
@Composable
private fun phoneTypeLabel(type: com.callerinfocom.data.model.PhoneType): String = when (type) {
    com.callerinfocom.data.model.PhoneType.MOBILE -> stringResource(R.string.phone_mobile)
    com.callerinfocom.data.model.PhoneType.HOME   -> stringResource(R.string.phone_home)
    com.callerinfocom.data.model.PhoneType.WORK   -> stringResource(R.string.phone_work)
    com.callerinfocom.data.model.PhoneType.OTHER  -> stringResource(R.string.phone_other)
}